...
public final class ThreadPoolManager {
    ...
    public static final int FIXED_THREAD  = 0;
    ...
    public ThreadPoolManager(){
        exec=new ThreadPoolExecutor(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE, KEEP_ALIVE_SECONDS, TimeUnit.SECONDS,
                sPoolWorkQueue, sThreadFactory);
        scheduleExec= Executors.newScheduledThreadPool(CORE_POOL_SIZE);
    }
    public ThreadPoolManager getDefault(){
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "ThreadPoolManager  Thread#" + mCount.getAndIncrement());
        }
    };
