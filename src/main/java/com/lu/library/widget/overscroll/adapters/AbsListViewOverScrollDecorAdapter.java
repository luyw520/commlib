package com.lu.library.widget.overscroll.adapters;
 ...
 * @author amit
 *
 * @see com.lu.library.widget.overscroll.HorizontalOverScrollBounceEffectDecorator
 * @see com.lu.library.widget.overscroll.VerticalOverScrollBounceEffectDecorator
 */
