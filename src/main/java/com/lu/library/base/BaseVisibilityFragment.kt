...
/**
 * https://mp.weixin.qq.com/s/_QEloSDCC9KbH4Cj1rU8OQ
 * Created by jun xu on 2020/11/26.
 *
 * 支持以下四种 case
 * 1. 支持 viewPager 嵌套 fragment，主要是通过 setUserVisibleHint 兼容，
 *  FragmentStatePagerAdapter BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT 的 case，
 *  因为这时候不会调用 setUserVisibleHint 方法，在 onResume check 可以兼容
 ...
 * 前提是一级 Fragment 和 二级 Fragment 都必须继承  BaseVisibilityFragment,
 * 且必须用 FragmentPagerAdapter 或者 FragmentStatePagerAdapter
